...
const TOOLS = [
  ...
  },
  {
    ...
    platforms: ['Windows', 'macOS', 'Linux'],
    techStack: ['Rust', 'TypeScript', 'Tauri 2'],
    description: 'Project planning and Gantt for building, infrastructure and civil works.',
    alternatives: ['Microsoft Project', 'Primavera P6', 'Asta Powerproject'],
    features: [
      'Gantt chart editing with dependencies',
      'WBS and task hierarchies',
      'Resource and calendar assignments',
      '4D linkage to IFCX models',
      'Critical path visualisation',
    ],
    whenToUse: 'Construction project scheduling with optional 4D linkage to BIM models.',
    standards: ['IFCX'],
  },
  {
