...
> Site inspection and quality control. Defect pinning on floorplans, NEN 2767 checklists, offline-first.

**Status:** alpha
**License:** LGPL-3.0
**Platforms:** Windows, macOS, Linux, Android, iOS
**Category:** Field / Inspection
**Current version:** v0.1.3 (2026-03-31)
...
- Releases: **4**
- Total downloads: **18**
- Downloads by platform: Android (9), Windows (5), Linux (rpm) (1), Linux (AppImage) (1), Linux (deb) (1), Windows (MSI) (1)
...
On-site inspections, snagging, NEN 2767 condition assessment, quality control with offline mobile use.
...
- Product page: https://www.open-aec.com/open-field-studio/
- Live demo: https://open-field-studio.open-aec.com/
- GitHub repo: https://github.com/OpenAEC-Foundation/Open-Field-Studio
- Latest stable release: https://github.com/OpenAEC-Foundation/Open-Field-Studio/releases/tag/v0.1.3
- Nightly builds: https://github.com/OpenAEC-Foundation/Open-Field-Studio/releases/tag/nightly
...
- [Linux (rpm) · Open.Field.Studio-0.1.0-1.x86_64.rpm](https://github.com/OpenAEC-Foundation/Open-Field-Studio/releases/download/v0.1.1/Open.Field.Studio-0.1.0-1.x86_64.rpm) (v0.1.1 — 3.7 MB)
- [Linux (AppImage) · Open.Field.Studio_0.1.0_amd64.AppImage](https://github.com/OpenAEC-Foundation/Open-Field-Studio/releases/download/v0.1.1/Open.Field.Studio_0.1.0_amd64.AppImage) (v0.1.1 — 77.6 MB)
